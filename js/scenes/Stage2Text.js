...
export class Stage2Text extends Phaser.Scene{
    constructor() {
        super({
            key: cst.SCENES.Stage2Text
        })
    }
    ...
    create() {
        ...
        this.add.image(0, 0, "stage_2").setOrigin(0).setDepth(0)  
    }

    update() {
        if(Phaser.Input.Keyboard.JustDown(this.Enter)) {
            this.scene.start(cst.SCENES.Stage2, {
